...
set NOTE_TEMPLATE_ID=https://mps.metamoji.com/link/*****.mmjloc
rem folder_uri: Update it with your folder
set FOLDER_URI=https://mps.metamoji.com/link/*****.mmjloc
rem note_new_uri
set NOTE_NEW_URI=http://127.0.0.1:8000/created_note
rem CSV file for multiple notes
rem set CSV_FILE=csv/propertyList.csv
set CSV_FILE=csv/propertyList_ja.csv
rem recordset_uri
set RECORDSET_URI=http://127.0.0.1:8000/recordset
rem page_template_id: Update it with your page template
set PAGE_TEMPLATE_ID=https://mps.metamoji.com/link/*****.mmjloc
