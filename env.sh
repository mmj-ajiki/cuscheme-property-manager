...
export NOTE_TEMPLATE_ID=https://mps.metamoji.com/link/*****.mmjloc
# folder_uri: Update it with your folder
export FOLDER_URI=https://mps.metamoji.com/link/*****.mmjloc
# note_new_uri
...
export PAGE_TEMPLATE_ID=https://mps.metamoji.com/link/*****.mmjloc
